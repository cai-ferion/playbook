...
const ioRoutes = ["server/io/shared.ts", "server/io/attendance-ops.ts", "server/io/attendance.ts", "server/io/audit-log.ts", "server/io/billing.ts", "server/io/coaching.ts", "server/io/corrective-actions.ts", "server/io/employees.ts", "server/io/insights.ts", "server/io/leaves.ts", "server/io/notifications.ts", "server/io/permissions.ts", "server/io/tasks.ts", "server/io/wfm.ts", "server/io/tardiness.ts", "server/io/role-change.ts", "server/io/managers-nook.ts", "server/io/group-tasks.ts", "server/io/shift-extensions.ts", "server/io/performance.ts"].map(f => readFile(f)).join("\n");
