...
router.post("/coaching", async (req: Request, res: Response) => {
  try {
    ...
    await db.insert(compassCoachingLogs).values({
      ...
      sme_joiner_2_name: body.sme_joiner_2_name,
      sme_joiner_2_email: body.sme_joiner_2_email,
      job_id: body.job_id,
      ...
      incident_timestamp: body.incident_timestamp,
      violation_type: body.violation_type,
      violation_subtype: body.violation_subtype,
